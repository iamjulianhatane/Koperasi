...
<head>
    ...
    <title>DANESHA | Tambah Data Pinjaman</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <textarea name="comment" rows="10" cols="100" value="<?php echo $ket_pinjam; ?>"></textarea>
                                    </br>
                                </div>
                            </div>
                            <div class="card-footer">
                                <div class="col-12">
                                    ...
                                    <a onclick="return confirm('Tambahkan data?')" href="tambah_pinjaman_proses.php" class="btn btn-success float-right text-light mx-1">Simpan</a>
                                </div>
                            </div>    
                        </div>
                    </div>
