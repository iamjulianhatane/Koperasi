              ...
              <div class="card-body">
                <table class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><?php echo $row["jml_simpanan"]; ?></td>
                    <td><?php echo $row["saldo"]; ?></td>
                    <td><?php echo $row["ket_simpan"]; ?></td>
                    <td>                    
                      <div class="btn-group btn-group-sm">
                        <a href="edit_simpanan.php" class="btn btn-info"><i class="fas fa-pen"></i></a>
                        <a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?')" href="hapus_simpanan.php" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>   
                  </tr>
                  </tbody>
                    <div class="card-header clearfix">
                      <a href="tambah_simpanan.php">
                        <button type="submit" class="btn btn-outline-primary float-right mx-1">
                          <i class="fas fa-plus">
                          </i> 
                          Tambah
                        </button>
