...
<head>
    ...
    <title>DANESHA | Tambah Anggota</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="col-12">
                                        <a href="data_anggota.php?ksp<?php echo $data=["id"]; ?>" class="btn btn-secondary float-right text-light mx-1">Kembali</a>
                                        <a onclick="return confirm('Tambahkan data?')" href="tambah_anggota_proses.php?ksp<?php echo $data=["id"]; ?>" class="btn btn-success float-right text-light mx-1">Simpan</a>
                                    </div>                                            
                                </div>
                            </div>
                        </div>
